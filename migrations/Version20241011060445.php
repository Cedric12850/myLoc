 ...
 */
final class Version20241011060445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borrow (id INT AUTO_INCREMENT NOT NULL, borrower_id INT NOT NULL, objet_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, INDEX IDX_55DBA8B011CE312B (borrower_id), INDEX IDX_55DBA8B0F520CF5A (objet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
